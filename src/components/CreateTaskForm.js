...
class CreateTaskForm extends Component {
  ...
  handleSubmit = e => {
    ...
    const { isAdminView, createTask, toggleCreateTaskModal } = this.props;
    ...
    let newTask = {
      ...
      rankWeight: calculateTaskRankWeight(priority, timeEstimate, newDate)
    };
  ...
  render() {
    ...
    return (
      <div className="CreateTaskForm-modal">
        <h4 className="m-3">
          <i className="far fa-plus-square" /> Create New Task
        </h4>
        <form>
          ...
          <div className="form-group">
            ...
            <textarea
              className="form-control CreateTaskForm-textarea"
